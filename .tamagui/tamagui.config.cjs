...
var config = (0, import_core2.createTamagui)({
  ...
  themes: {
    ...
    light: {
      ...themes.light,
      background: tokens2.color.background,
      color: tokens2.color.text,
      primary: tokens2.color.primary,
      secondary: tokens2.color.secondary
    },
    dark: {
      ...themes.dark,
      background: tokens2.color.backgroundDark,
      color: tokens2.color.textDark,
      primary: tokens2.color.primary,
      secondary: tokens2.color.secondary
    }
  },
